...
/* history */
INSERT INTO history(h_uname, h_title, h_date, h_time, h_hallno, h_seats, adult, student, children, f_id, t_datetime, t_amount, t_cardtype, t_cardnum) VALUES("Pyrexia02", "Spider-Man: No Way Home", "2022-1-18", "08:00", "01", "i10;i11;i12;i13", 3, 1, 0, "1;1;8;8;8;5", "2022-1-10", 134, "credit", "1435-4956-0984-2365");
INSERT INTO history(h_uname, h_title, h_date, h_time, h_hallno, h_seats, adult, student, children, f_id, t_datetime, t_amount, t_cardtype, t_cardnum) VALUES("rony456", "Spider-Man: No Way Home", "2022-1-18", "08:00", "01", "g14;g15;h14;h15", 4, 0, 0, "1;4;5;5;6", "2022-1-15", 141, "debit", "9087-4562-1328-5336");
INSERT INTO history(h_uname, h_title, h_date, h_time, h_hallno, h_seats, adult, student, children, f_id, t_datetime, t_amount, t_cardtype, t_cardnum) VALUES("waytheking", "Spider-Man: No Way Home", "2022-1-18", "08:00", "01", "i15;i16;i17", 2, 0, 1, "1;4;8;9", "2022-1-17",102, "debit", "3067-5164-1178-5135");
INSERT INTO history(h_uname, h_title, h_date, h_time, h_hallno, h_seats, adult, student, children, f_id, t_datetime, t_amount, t_cardtype, t_cardnum) VALUES("waytheking", "Spider-Man: No Way Home", "2022-1-18", "08:00", "01", "i15;i16;i17", 2, 0, 1, "1;4;8;9", "2022-1-17",102, "debit", "3067-5164-1178-5135");
INSERT INTO history(h_uname, h_title, h_date, h_time, h_hallno, h_seats, adult, student, children, f_id, t_datetime, t_amount, t_cardtype, t_cardnum) VALUES("waytheking", "Spider-Man: No Way Home", "2022-1-18", "08:00", "01", "i15;i16;i17", 2, 0, 1, "1;4;8;9", "2022-1-17",102, "debit", "3067-5164-1178-5135");
INSERT INTO history(h_uname, h_title, h_date, h_time, h_hallno, h_seats, adult, student, children, f_id, t_datetime, t_amount, t_cardtype, t_cardnum) VALUES("waytheking", "Spider-Man: No Way Home", "2022-1-18", "08:00", "01", "i15;i16;i17", 2, 0, 1, "1;4;8;9", "2022-1-17",102, "debit", "3067-5164-1178-5135");
...
/* movies */
INSERT INTO movies(m_title, m_reldate, synopsis, adultp, studentp, childrenp) VALUES("Spider-Man: No Way Home", "2022-01-10", "With Spider-Man's identity now revealed, Peter asks Doctor Strange for help. When a spell goes wrong, dangerous foes from other worlds start to appear, forcing Peter to discover what it truly means to be Spider-Man.", 28, 18, 20);
...
INSERT INTO movies(m_title, m_reldate, synopsis, adultp, studentp, childrenp) VALUES("Mulan", "2021-11-3", "A girl disguises as a male warrior and joins the imperial army in order to prevent her sick father from being forced to enlist as he has no male heir.", 28, 18, 20);
INSERT INTO movies(m_title, m_reldate, synopsis, adultp, studentp, childrenp) VALUES("Train to Busan", "2021-9-12", "Seok-woo and his daughter are on a train to Busan on the latter's birthday to see his wife. However, the journey turns into a nightmare when they are trapped amidst a zombie outbreak in South Korea.", 28, 18, 20);
INSERT INTO movies(m_title, m_reldate, synopsis, adultp, studentp, childrenp) VALUES("Aladdin", "2022-1-7", "Aladdin, a kind thief, woos Jasmine, the princess of Agrabah, with the help of Genie. When Jafar, the grand vizier, tries to usurp the king, Jasmine, Aladdin and Genie must stop him from succeeding.", 28, 18, 20);
...
INSERT INTO movies(m_title, m_reldate, synopsis, adultp, studentp, childrenp) VALUES("Your Name", "2022-1-1", "Two teenagers share a profound, magical connection upon discovering they are swapping bodies. Things manage to become even more complicated when the boy and girl decide to meet in person.", 28, 18, 20);
